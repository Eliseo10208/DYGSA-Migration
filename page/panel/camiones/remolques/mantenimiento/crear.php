<button class="back_btn" onclick="pagemenu('camiones', {q: 'remolques', d: 'mantenimiento', u: '<?php echo $remolque['id'];?>'})">Regresar</button>

<div class="panel">
	<div class="panel-header">
		<div class="title">
			Agregar un mantenimiento a <?php echo $remolque['placa'];?>
	...
	<form class="form_s crear_mantenimiento" data-ajax="false" method="post" enctype="multipart/form-data">
		<div class="row justify-content-md-center">
			<div class="col-md-8">
				<input name="remolque" type="hidden" value="<?php echo $remolque['id'];?>">
				<div class="group">
	...
	<script type="text/javascript">
		$('.crear_mantenimiento').ajaxForm({
	    	url: site.url+'/system/Actions/camion/remolques/crear_mantenimiento.php',
	        complete: function(xhr) {
	            ...
	            var value = JSON.parse(xhr.responseText);
	           	...
	           	{
	           		pagemenu('camiones', {q: 'remolques', d: 'mantenimiento', u: '<?php echo $remolque['id'];?>'});
	           	}
	        }
	    });
	</script>
