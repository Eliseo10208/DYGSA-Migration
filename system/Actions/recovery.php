<?php
	...
	$check = $sql->query("SELECT * FROM `admin_users` WHERE `email` = '".$correo."'");
	if(!$check->num_rows)
	{
	...
	$code = Core::genCode(20);
	$sql->query("INSERT INTO `recovery` SET `code` = '".$code."', `id_admin` = '".$check['id']."'");

	use PHPMailer\PHPMailer\PHPMailer;
	use PHPMailer\PHPMailer\SMTP;
	use PHPMailer\PHPMailer\Exception;

	require Modules.'mailer/Exception.php';
	require Modules.'mailer/PHPMailer.php';
	require Modules.'mailer/SMTP.php';
	...
	try {
	    ...
	    $mail->SMTPAuth   = true;
	    $mail->Username   = 'recovery@dygsa.online';
	    $mail->Password   = 'Pelusa-78';
	    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
	    $mail->Port       = 465;

	    //Recipients
	    $mail->setFrom('recovery@dygsa.online', 'Digsa Soporte');
...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
      ...
      <img border="0" vspace="0" hspace="0"
				src="https://i.imgur.com/P0kdeqk.png"
				width="200"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;" class="list-item"><table align="center" border="0" cellspacing="0" cellpadding="0" style="width: inherit; margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0;">
			...
			<tr>
             ...
             enlace en tu navegador <span style="font-size:11px;">'.$site['url'].'/recovery/'.$code.'</span>
...
<!-- End of SECTION / BACKGROUND -->
	    ...
	    echo json_encode(array('status' => 'success', 'msg' => 'Se ha enviado un mensaje al correo electrónico.'));
	} catch (Exception $e) {
	    echo json_encode(array('status' => 'error', 'msg' => 'No se pudo enviar el correo electrónico.'));
	}
?>